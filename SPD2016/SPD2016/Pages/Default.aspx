...
<asp:Content ContentPlaceHolderID="PlaceHolderAdditionalPageHead" runat="server">
    <script src="../_layouts/15/SPD2016/script/libs.min.js" type="text/javascript"></script>

	<script type="text/javascript">
		ExecuteOrDelayUntilScriptLoaded(function () {
			System.config({ defaultJSExtensions: true, baseURL: '/_layouts/15/SPD2016/script' });
			System.import('SPD2016.Load.js').then(null, console.error.bind(console));
		}, 'sp.js');
	</script>
</asp:Content>
